...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR OAJED ~
\033[1;97m************************************************
...
CorrectUsername = "Oajedbd"
CorrectPassword = "TOWFIK"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/Oajedul.official.1')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mOAJEDUL\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mOAJEDUL-MOTIN\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mTOWFIK BOSS start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mTowfik-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mTOWFIK-Checkpoint'
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mOAJED-TOWFIK\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By OAJEDUL-MOTIN--•◈•---»" #Dev:TOWFIK
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 TOWFIK.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..TOWFIK BOSS Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mOajedul.official.1 """
